...
app.post("/submit", (req, res) => {
  ...
  let advCount = Math.floor(Math.random() * adj.length)
  let nounCount = Math.floor(Math.random() * adj.length)
  let names = adj[advCount] + noun[nounCount];
  console.log(adj[advCount] + noun[nounCount]);
  res.render("index.ejs",{randomNames:names});
});
